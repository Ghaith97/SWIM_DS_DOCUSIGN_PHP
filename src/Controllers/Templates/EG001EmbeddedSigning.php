...
class EG001EmbeddedSigning extends BaseController
{
    ...
    private $signer_client_id1 = 1001;
    private $signer_client_id2 = 1002;# Used to indicate that the signer will use an embedded
    ...
    private function make_envelope(array $args): EnvelopeDefinition
    {
        ...
        $signer1 = new Signer([ # The signer
            'email' => $args['signer_email'], 'name' => $args['signer_name'],
            'recipient_id' => "1", 'routing_order' => "1",
            # Setting the client_user_id marks the signer as embedded
            'client_user_id' => $args['signer_client_id1']
        ]);
        $signer2 = new Signer([ # The signer
            'email' => $args['signer_email'], 'name' => $args['signer_name'],
            'recipient_id' => "1", 'routing_order' => "1",
            # Setting the client_user_id marks the signer as embedded
            'client_user_id' => $args['signer_client_id2']
        ]);
